    ...
    <div class="m-auto w-[90vw]  lg:w-[80vw] max-w-[1500px] min-h-[1000px]">
      ...
      <div class="flex justify-between">
        <div class="flex w-full flex-col md:flex-row mb-10 select-none">
          <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
            :initial-opacity="0" :animate-opacity="true" :scale="1.05" :threshold="0" :always-play="true" :delay="0.4">
          ...
          <div class="text-2xl md:ml-10 flex flex-col self-center mt-5 md:mt-0">
            ...
            <AnimatedContent :distance="30" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
              :initial-opacity="0" :animate-opacity="true" :scale="1.05" :threshold="0" :always-play="true"
              :delay="0.6">
              <p class="ml-[1em] lg:ml-0 text-3xl lg:text-4xl mt-2 mb-2"><span
                  class="inline-hovertrans">xzadudu179</span></p>
            </AnimatedContent>
            <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
              :initial-opacity="0" :animate-opacity="true" :scale="1.05" :threshold="0" :always-play="true"
              :delay="0.7">
            ...
            <AnimatedContent :distance="30" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
              :initial-opacity="0" :animate-opacity="true" :scale="1.05" :threshold="0" :always-play="true"
              :delay="0.8">
              <p class="ml-[1em] lg:ml-0 text-3xl lg:text-4xl mt-2"><span class="inline-hovertrans">Yangzhou</span>,
                <span class="inline-hovertrans">Jiangsu</span>,
                <span class="inline-hovertrans">China</span>
              </p>
            </AnimatedContent>
            <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
              :initial-opacity="0" :animate-opacity="true" :scale="1.05" :threshold="0" :always-play="true"
            ...
            <AnimatedContent :distance="30" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
              :initial-opacity="0" :animate-opacity="true" :scale="1.05" :threshold="0" :always-play="true" :delay="1">
              <p class="ml-[1em] lg:ml-0 text-3xl lg:text-4xl mt-2 mb-2"><span
                  class="inline-hovertrans">2007-04-04</span></p>
            </AnimatedContent>
          </div>
        </div>
        <div class="text-4xl right-icons hidden lg:flex">
          <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
            ...
            <div><a href="https://blog.xzadudu179.top"
                class="hover:text-primary-200 cursor-target cursor-none pr-1 pl-1 m-2"><i
      ...
      <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
        :initial-opacity="0" :animate-opacity="true" :scale="1.05" :threshold="0" :always-play="true" :delay="0.6">
        <p
          class="font-normal font-firacode text-lg md:text-2xl mb-5 select-none text-primary-200 text-center md:text-left">
          <span class="inline-block mr-1">&gt;</span>
          <TextType :text="type_texts" :typingSpeed="100" :pauseDuration="2000" :showCursor="true" cursorCharacter="_"
            :textColors="['#78B9FF']" class="" />
        </p>
      </AnimatedContent>
      <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
        :initial-opacity="0" :animate-opacity="true" :scale="1.05" :threshold="0" :always-play="true" :delay="0.5">
        <div
          ...
          <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
            :initial-opacity="0" :animate-opacity="true" :scale="1" :threshold="0" :always-play="true" :delay="0.7">
            <p><span class="hoverlight">a.k.a. 九镹、九九、179</span></p>
          </AnimatedContent>
          <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
            :initial-opacity="0" :animate-opacity="true" :scale="1" :threshold="0" :always-play="true" :delay="0.8">
            <p><span class="hoverlight">一个正在四处游荡与探索的小生物... 对于前端、动效、UX 设计有着奇怪的着迷？</span>
            </p>
          </AnimatedContent>
          <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
            :initial-opacity="0" :animate-opacity="true" :scale="1" :threshold="0" :always-play="true" :delay="0.9">
            <p><span class="hoverlight">什么都做一点，副业是曲师，想做出自己的游戏，以及参与更多人的项目。</span></p>
          </AnimatedContent>
          <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
            :initial-opacity="0" :animate-opacity="true" :scale="1" :threshold="0" :always-play="true" :delay="1">
            <p><span class="hoverlight">想在世界上留下足迹，让更多人发现自己...</span></p>
          </AnimatedContent>
          <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
            :initial-opacity="0" :animate-opacity="true" :scale="1" :threshold="0" :always-play="true" :delay="1.1">
            <p><span class="hoverlight">对于细节莫名地在意，是一个偏向于完美主义的人 _(・ω・｣ ∠)_</span></p>
          </AnimatedContent>
          <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
            :initial-opacity="0" :animate-opacity="true" :scale="1" :threshold="0" :always-play="true" :delay="1.2">
      ...
      <FadeContent :blur="true" :duration="1000" :delay="1300" :threshold="0" :always-play="true" :initial-opacity="0"
        easing="ease-out">
        <div :style="{ height: '100px', position: 'relative', overflow: 'hidden' }">
          <LogoLoop :logos="techLogos" :speed="80" direction="left" :logoHeight="48" :gap="40" :pauseOnHover="true"
            :scaleOnHover="true" :fadeOut="true" fadeOutColor="#020211" />
        </div>
      </FadeContent>
      <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
        :initial-opacity="0" :animate-opacity="true" :scale="1.1" :threshold="0" :always-play="true" :delay="0.5">
        <p class="text-3xl md:text-5xl font-light mb-7 select-none "># <span class="inline-hovertrans">INTERESTS</span>
        </p>
      </AnimatedContent>
      <div class="text-lg md:text-lg main-content font-normal mb-15 tracking-[0.09em] text-dark-100">
        <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
          :initial-opacity="0" :animate-opacity="true" :scale="1.05" :threshold="0" :always-play="true" :delay="0.7">
          <p class="mb-5"><span class="hoverlight text-3xl text-primary-200 select-none">// MUSIC</span></p>
        </AnimatedContent>
        <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
          :initial-opacity="0" :animate-opacity="true" :scale="1.05" :threshold="0" :always-play="true" :delay="0.8">
        ...
        <div class="flex flex-col md:flex-row hg:justify-around justify-center md:justify-start m-auto flex-wrap mb-10">
      ...
      <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
        :initial-opacity="0" :animate-opacity="true" :scale="1.1" :threshold="0" :always-play="true" :delay="0.2">
        <p class="text-3xl md:text-5xl font-light mb-7 select-none"># <span class="inline-hovertrans">CONTACT</span>
        </p>
      </AnimatedContent>
      <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
        :initial-opacity="0" :animate-opacity="true" :scale="1.05" :threshold="0" :always-play="true" :delay="0.5">
        <div class=" text-lg md:text-lg main-content font-normal mb-8 tracking-[0.09em] text-dark-100 indent-[1em]">
      ...
      <!-- <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
            ...
            <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
                ...
                <a href="https://blog.xzadudu179.top" class="cursor-none">
                    <div
                        class="p-5 border-4 border-dark-400 rounded-2xl m-auto hovertrans hover:text-primary-200 active:text-primary-200 cursor-target">
      ...
      <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
        :initial-opacity="0" :animate-opacity="true" :scale="1" :threshold="0" :always-play="false" :delay="0.2">
        ...
        <p class="block text-3xl md:hidden md:text-5xl select-none mb-7 mt-20 font-light "># <span
            class="inline-hovertrans">MESSAGES <i class="fa-light fa-message-lines text-[0.9em] relative"></i></span></p>
      </AnimatedContent>
      <div
        ...
        <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
          :initial-opacity="0" :animate-opacity="true" :scale="1" :threshold="0" :always-play="false" :delay="0.3">
          <p class="font-normal"><span class="hoverlight">Welcome To My Message Board</span>
          </p>
        </AnimatedContent>
        <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
          :initial-opacity="0" :animate-opacity="true" :scale="1" :threshold="0" :always-play="false" :delay="0.4">
          <p><span class="hoverlight text-primary-200 text-sm md:text-lg">// 有什么想说的，或是留言、问候，都可以在这里说说哦！</span>
          </p>
        </AnimatedContent>
        <AnimatedContent :distance="20" direction="vertical" :reverse="false" :duration="1.1" ease="power3.out"
          :initial-opacity="0" :animate-opacity="true" :scale="1" :threshold="0" :always-play="false" :delay="0.5">
