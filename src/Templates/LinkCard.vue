                ...
                <div
                    ...
                    <div class="ml-[3vw] flex flex-col justify-evenly  text-content">
                        <p
                            ...
                            <span class=""><span class="hoverlight">{{ props.name }}</span>
                            </span>
                        </p>
                    ...
                    <div class="justify-center items-center text-center m-auto flex flex-col">
                        <p class="text-dark-400">
                            <a :href="props.href"
                                class="no-cursor href text-[9vw] md:text-[8vw] active-primary hover-primary"
                                target="_blank">
...
.custom-spotlight-card {
    padding: 0;
    transition-property: transform, background, color, border, text-shadow;
    transition: 0.3s;
