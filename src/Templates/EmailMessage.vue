        ...
        <form @submit.prevent="sendEmail"
            ...
            <div class="content">
                ...
                <div class="flex flex-col-reverse md:flex-row-reverse items-center">
                    <button type="submit"
                        class="text-center w-full md:w-auto ml-auto border-2 md:border-0 text-3xl p-3 rounded-2xl border-dark-300 active:border-primary-200 active:text-primary-200 hover:border-primary-200 hover:text-primary-200 text-dark-200 hoverlight md:block submit cursor-target hovertrans">
                        {{ submitText }}
